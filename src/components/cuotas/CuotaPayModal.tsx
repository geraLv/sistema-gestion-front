...
export function CuotaPayModal({ cuota, comprobantesPrevios = [], onClose, onConfirm }: CuotaPayModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center m-4">
            ...
            <div className="flex flex-col relative w-full max-w-xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
